...
export const sendLocal = new Proxy({_receiver: receive}, {
    get(target, key, receiver) {
        const type = key;
...
export const tabGroupManagerProxy = new Proxy({}, {
    get(target, key, receiver) {
        return (...args) => {
            const payload = {method: key, args};
            return send.tgmMethod(payload);
        };
    }
});